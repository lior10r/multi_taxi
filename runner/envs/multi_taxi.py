...
class MultiTaxiCreator(EnvCreator):
    ...
    def create_env():
        ...
        custom_reward_table = TAXI_ENVIRONMENT_REWARDS.copy()
        custom_reward_table[Event.BAD_DROPOFF] = -1
        custom_reward_table[Event.BAD_PICKUP] = -10
        custom_reward_table[Event.FINAL_DROPOFF] = 1000
        custom_reward_table[Event.PICKUP] = 1000
        custom_reward_table[Event.OUT_OF_TIME] = -200
        custom_reward_table[Event.STEP] = -1
        custom_reward_table[Event.HIT_OBSTACLE] = -100
        custom_reward_table[Event.COLLISION] = -50
        custom_reward_table[Event.INTERMEDIATE_DROPOFF] = -10
        ...
        return multi_taxi_v0.parallel_env(
            ...
            num_passengers=2,                  # there are 3 passengers in the environment
            max_steps=3000,
            reward_table=custom_reward_table,
            intermediate_dropoff_reward_by_distance=True,
            max_capacity=[1, 1],               # taxi_0 can carry 1 passenger, taxi_1 can carry 2
            ...
            has_standby_action=False,           # all taxis can perform the standby action
